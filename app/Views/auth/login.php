...
<?php if ($voltar): ?><input type="hidden" name="voltar" value="planos"><p class="small muted">Depois de entrar, você volta para os planos para concluir a assinatura.</p><?php endif; ?>
